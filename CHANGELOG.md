...
## v0.2.19（2026-08）— 网页壁纸模式显示浮层控制面板
- 修复网页壁纸模式下控制面板不可见：进入网页壁纸自动创建浮层面板，背景/樱花/可视化/天气/音量等可直接在面板调节
- 按钮按状态显示“网页壁纸 / 退出网页壁纸”；视频壁纸与网页壁纸互斥切换
- 静音基础圆环放大（0.03 → 0.08），更容易看到音频可视化已生效
